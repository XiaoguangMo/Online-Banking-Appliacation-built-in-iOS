...
@property (retain, nonatomic) NSString *account2;
@property (retain, nonatomic) NSString *currency2;
@property (retain, nonatomic) NSString *account2type;
